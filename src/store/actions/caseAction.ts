...
export enum CaseTypes {
    ...
    CREATE_NOTE_ENGAGEMENT,
    CREATE_NOTE_ENGAGEMENT_SUCCESS,
    CREATE_NOTE_ENGAGEMENT_FAILURE,
    CREATE_CALL_ENGAGEMENT,
    CREATE_CALL_ENGAGEMENT_SUCCESS,
    CREATE_CALL_ENGAGEMENT_FAILURE,
    CREATE_EMAIL_ENGAGEMENT,
    CREATE_EMAIL_ENGAGEMENT_SUCCESS,
    CREATE_EMAIL_ENGAGEMENT_FAILURE,
}
